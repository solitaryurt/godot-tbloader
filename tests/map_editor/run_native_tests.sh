...
"${CXX:-clang++}" -std=c++17 -g -O1 -fno-omit-frame-pointer \
  ...
  src/map/map_data.cpp src/map/map_parser.cpp src/map/map_writer.cpp src/map/map_edit.cpp src/map/brush_topology.cpp src/map/brush_geometry_math.cpp src/map/editor_brush_geometry.cpp \
